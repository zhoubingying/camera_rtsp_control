...
# 打开摄像头
cap = cv2.VideoCapture('rtmp://192.168.0.115:1935/live/stream')
...
"""
rtspUrl = "rtsp://192.168.8.136:554/stream"
...
#ffplay rtmp://192.168.88.128:1935/live/test
...
while True:
    ...
    try:
        ...
        print("Pushing the camera of %s appear ERROR:%s" % ('rtmp', rtmpUrl))
